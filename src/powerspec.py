...
def spectra_flux(_u,_v,navlon,navlat,window='Tukey',detrend='Both'):
    '''This fuctions implement the computation of kinetic energy spectral flux following the
        flux = \int^{ks}_{k} u ....
        ...
        Input:
            ...
            navlon :
            navlat :
            window : None, 'Tukey' or 'Hanning.
            detrend : None or True
...
def weighted_scale(wavenumber,psd,axs=None):
    '''Computed weighted scale from wavenumber spectra density.
