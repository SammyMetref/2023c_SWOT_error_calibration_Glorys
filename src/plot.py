...
def plot_demo_pass(file_ref_input, file_calib,ilmax=None):
    swt_input = SwotTrack(file_ref_input,ilmax=ilmax)
    ...
    swt_calib = SwotTrack(file_calib,ilmax=ilmax)
    ...
    x_al0 = 2*(swt_input._dset.time-swt_input._dset.time[0]) 
